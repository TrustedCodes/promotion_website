...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteLogo = "../../static/admin/dist/img/logo2.png";
    public static final String websiteIcon = "../../static/admin/dist/img/favicon.png";

    public static final String yourAvatar = "../../static/admin/dist/img/13.png";
    public static final String yourEmail = "1311664842@qq.com";
    public static final String yourName = "CodeTiger";

    public static final String footerAbout = "your personal blog. have fun.";
    public static final String footerICP = "浙ICP备 xxxxxx-x号";
    public static final String footerCopyRight = "@2020 CodeTiger";
